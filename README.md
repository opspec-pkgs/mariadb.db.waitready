[![Build Status](https://github.com/opspec-pkgs/mariadb.db.waitready/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/mariadb.db.waitready/actions?query=workflow%3Abuild+branch%3Amain)
